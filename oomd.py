...
#Average temperature=0.764659 (91.300253 K)
#Average pressure=-0.853292
#displace^2 vs t: slope=0.006793 intercept=0.073864 R2=0.190013
#Diffusion constant from Einstein relation=0.001132
#Diffusion constant from Einstein relation=0.060865 (x10-5 cm^2/sec)
#Diffusion constant from vel autocorr=0.000316
#Diffusion constant from vel autocorr=0.016970 (x10-5 cm^2/sec)
#Equilibration time=0.093 minutes
   #Production time=1.932 minutes
   # Total run time=2.024 minutes
